import 'package:app_client/pages/FirmodeScreen2.dart';
...
class FillFirFirMode extends StatefulWidget {
  const FillFirFirMode({super.key});

  @override
  _FillFirFirModeState createState() => _FillFirFirModeState();
}

class _FillFirFirModeState extends State<FillFirFirMode> {
  String? _chosenvalue;
  String? screen;
            ...
            children: [
              Column(
                ...
                children: [
                            ...
                            onChanged: (String? value) {
                              ...
                              if (value == 'Law') {
                                Navigator.pushReplacement(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        FillFirLawMode(), // Create this screen
                                  ),
                                );
                              }
                            },
                  ...
                  SizedBox(height: 5),
                  Text(
                    'Please answer a few questions for Generating an FIR',
                  ...
                  Center(
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        print(crimeDescriptionController.text);
